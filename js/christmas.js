	...
	*/
    $("#curs").click(function(){
        ...
        str += 'Em biết em không thể nói ngọt ngào\n';
        str += 'Nhưng em sẽ chứng minh nó bằng hành động\n';
        str += 'Em tin rằng, đây là lời thề tốt nhất cho anh\n';
        str += 'Suốt cuộc đời này, em sẽ ở bên anh\n';
        str += 'Anh sẽ là gió, anh sẽ là tuyết\n';
        str += ' xuân hạ thu đông là anh\n';
        str += 'Bất cứ đâu anh thấy\n';
        str += 'mãi yêu\n';
        str += 'anh';
        Printer.init(str, {
            //speed: 90  
